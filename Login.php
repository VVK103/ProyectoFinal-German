                ...
                <div class="card login-card shadow-lg border-0 rounded-lg">
                    ...
                    <div class="card-body p-5">
                        ...
                        <div class="mt-3 text-center">
                            <a href="http://localhost/ProyectoFinal-German/Registro.php">¿No tienes una cuenta? Regístrate</a>
                        </div>
                    </div>
                </div>
            </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM usuarios WHERE nombre = ? AND email = ? AND password = ?";
    ...
    if ($stmt) {
        ...
        if ($resultado->num_rows > 0) {
            echo "<div class='alert alert-success text-center'>¡Bienvenido, " . htmlspecialchars($usuario) . "!</div>";
        } else {
            echo "<div class='alert alert-danger text-center'>Error: Usuario, correo o contraseña incorrectos.</div>";
        }
